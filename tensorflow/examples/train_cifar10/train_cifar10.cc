...
==============================================================================*/
// A simple program trainging a CIFAR TF model using TF C++ API
...
int main(int argc, char* argv[]) {
  ...
  LOG(INFO) << "[CIFAR Dataset Directory] = " << cifarDir ;

  cifar10Reader cifar = cifar10Reader();

  LOG(INFO) << "[CIFAR Dataset] Num of Training Images = " << cifar.getTrainingDataSize();
  LOG(INFO) << "[CIFAR Dataset] Num of Training Labels = " << cifar.getTrainingDataSize();
  LOG(INFO) << "[CIFAR Dataset] Num of Test     Images = " << cifar.getTestingDataSize();
  LOG(INFO) << "[CIFAR Dataset] Num of Test     Labels = " << cifar.getTestingDataSize();
  LOG(INFO) << "[CIFAR Dataset] Input Image Size       = " << cifar.getImgSize();
