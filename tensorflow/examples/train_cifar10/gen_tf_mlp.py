...
"""A very simple CIFAR classifier.
...
def main(_):
    ...
    n_input = 32*32*3 # CIFAR10 data input (img shape: 28*28)
    n_classes = 10 # CIFAR10 total classes (0-9 digits)
    ...
    with tf.Session() as sess:
        ...
        for step in range(maxEpochs):
            ...
            if step % testStep == 0:
                ...
                acc, summary = sess.run([accuracy, merged_summary_op],
                    feed_dict={X: testingImages, Y: testingLabels})
        ...
        tf.train.write_graph(sess.graph_def,
                            './',
                            'cifar10_mlp.pb', as_text=False)

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--logDir', type=str, default='/tmp/tensorflow_logs/cifar10/mlpnet',
